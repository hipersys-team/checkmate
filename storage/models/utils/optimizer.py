...
class ZeroRedundancyOptimizer(Optimizer, Joinable):
    ...
    def __init__(
        ...
        **defaults: Any,
        ...
        if not overlap_with_ddp:
            self._init_local_optimizer(params_per_rank)
        else:
    ...
    # After calling this method, rank 0 will have the consolidated state. This
    # cannot be used to consolidate the optimizer state across all ranks.
    def consolidate_state(self) -> None:
        # Sync model parameters on each rank.
        self._sync_params()
    ...
    def step(
        ...
        **kwargs: Any,
        ...
        # Note: This is because PyTorch uses sharded optimizer for DDP where each
        # rank only has all the parameters
        # self._sync_params()
    ...
    def _init_local_optimizer(
        ...
        param_groups = self._partition_parameters(params_per_rank)[self.rank]
